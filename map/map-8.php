...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 8</title>
    ...
    <div class="row">
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                    <a class="dropdown-item alert-primary " href="#8-1N">State 8-1</a>
                    <a class="dropdown-item alert-primary " href="#8-2N">State 8-2</a>
                    <a class="dropdown-item alert-primary " href="#8-3N">State 8-3</a>
                    <a class="dropdown-item alert-primary " href="#8-4N">State 8-4</a>  
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#8-1H">State 8-1</a>
                    <a class="dropdown-item alert-danger " href="#8-2H">State 8-2</a>
                    <a class="dropdown-item alert-danger " href="#8-3H">State 8-3</a>
                    <a class="dropdown-item alert-danger " href="#8-4H">State 8-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '8' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
