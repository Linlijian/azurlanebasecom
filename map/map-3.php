...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 3</title>
    ...
    <div class="row">
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                  <a class="dropdown-item alert-primary " href="#3-1N">State 3-1</a>
                  <a class="dropdown-item alert-primary " href="#3-2N">State 3-2</a>
                  <a class="dropdown-item alert-primary " href="#3-3N">State 3-3</a>
                  <a class="dropdown-item alert-primary " href="#3-4N">State 3-4</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#3-1H">State 3-1</a>
                    <a class="dropdown-item alert-danger " href="#3-2H">State 3-2</a>
                    <a class="dropdown-item alert-danger " href="#3-3H">State 3-3</a>
                    <a class="dropdown-item alert-danger " href="#3-4H">State 3-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '3' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
