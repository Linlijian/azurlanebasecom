...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 2</title>
        ...
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                    <a    class="dropdown-item alert-primarydisabled " href="#1-1N">State 1-1</a>
                ...
                <div class="dropdown-menu  alert-success">
                  <a class="dropdown-item alert-primary " href="#2-1N">State 2-1</a>
                  <a class="dropdown-item alert-primary " href="#2-2N">State 2-2</a>
                  <a class="dropdown-item alert-primary " href="#2-3N">State 2-3</a>
                  <a class="dropdown-item alert-primary " href="#2-4N">State 2-4</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#2-1H">State 2-1</a>
                    <a class="dropdown-item alert-danger " href="#2-2H">State 2-2</a>
                    <a class="dropdown-item alert-danger " href="#2-3H">State 2-3</a>
                    <a class="dropdown-item alert-danger " href="#2-4H">State 2-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu  alert-success">
                    ...
                    <a    class="dropdown-item alert-primary disabled" href="#">State 4-3</a>
                    <a    class="dropdown-item alert-primary disabled" href="#">State 4-4</a>
                    <div class="dropdown-divider"></div>
                    <a    class="dropdown-item alert-danger disabled" href="#">State 4-1</a>
                    <a    class="dropdown-item alert-danger disabled" href="#">State 4-2</a>
                    <a    class="dropdown-item alert-danger disabled" href="#">State 4-3</a>
                    <a    class="dropdown-item alert-danger disabled" href="#">State 4-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '2' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
