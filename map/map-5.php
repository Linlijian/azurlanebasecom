...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 5</title>
    ...
    <div class="row">
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                    <a class="dropdown-item alert-primary " href="#5-1N">State 5-1</a>
                    <a class="dropdown-item alert-primary " href="#5-2N">State 5-2</a>
                    <a class="dropdown-item alert-primary " href="#5-3N">State 5-3</a>
                    <a class="dropdown-item alert-primary " href="#5-4N">State 5-4</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#5-1H">State 5-1</a>
                    <a class="dropdown-item alert-danger " href="#5-2H">State 5-2</a>
                    <a class="dropdown-item alert-danger " href="#5-3H">State 5-3</a>
                    <a class="dropdown-item alert-danger " href="#5-4H">State 5-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '5' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
