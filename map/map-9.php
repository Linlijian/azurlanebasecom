...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 9</title>
    ...
    <div class="row">
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                    <a class="dropdown-item alert-primary " href="#9-1N">State 9-1</a>
                    <a class="dropdown-item alert-primary " href="#9-2N">State 9-2</a>
                    <a class="dropdown-item alert-primary " href="#9-3N">State 9-3</a>
                    <a class="dropdown-item alert-primary " href="#9-4N">State 9-4</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#9-1H">State 9-1</a>
                    <a class="dropdown-item alert-danger " href="#9-2H">State 9-2</a>
                    <a class="dropdown-item alert-danger " href="#9-3H">State 9-3</a>
                    <a class="dropdown-item alert-danger " href="#9-4H">State 9-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '9' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
