...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 7</title>
    ...
    <div class="row">
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                    <a class="dropdown-item alert-primary " href="#7-1N">State 7-1</a>
                    <a class="dropdown-item alert-primary " href="#7-2N">State 7-2</a>
                    <a class="dropdown-item alert-primary " href="#7-3N">State 7-3</a>
                    <a class="dropdown-item alert-primary " href="#7-4N">State 7-4</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#7-1H">State 7-1</a>
                    <a class="dropdown-item alert-danger " href="#7-2H">State 7-2</a>
                    <a class="dropdown-item alert-danger " href="#7-3H">State 7-3</a>
                    <a class="dropdown-item alert-danger " href="#7-4H">State 7-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '7' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
