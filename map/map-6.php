...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Azur lane basecom - Map 6</title>
    ...
    <div class="row">
        <div class="col">
            <!-- <form action="map.php" method="POST"> -->
                ...
                <div class="dropdown-menu  alert-success">
                    <a class="dropdown-item alert-primary " href="#6-1N">State 6-1</a>
                    <a class="dropdown-item alert-primary " href="#6-2N">State 6-2</a>
                    <a class="dropdown-item alert-primary " href="#6-3N">State 6-3</a>
                    <a class="dropdown-item alert-primary " href="#6-4N">State 6-4</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item alert-danger " href="#6-1H">State 6-1</a>
                    <a class="dropdown-item alert-danger " href="#6-2H">State 6-2</a>
                    <a class="dropdown-item alert-danger " href="#6-3H">State 6-3</a>
                    <a class="dropdown-item alert-danger " href="#6-4H">State 6-4</a>
                </div>
                </li>
                <li class="nav-item dropdown">
...
<div class="alert alert-info" role="alert">
    <div class = "container">
                <?php
                    $sql = "SELECT * FROM `location` WHERE a = '6' ORDER BY a";
                    $r = $conn->query($sql);
                     $i = 0;
                    // $j = 0;
                    //  $drop[];
