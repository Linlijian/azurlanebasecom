...
<html lang="en">
  <head>
    ...
    <title>Azur lane basecom - Weapon Fighters</title>
    <!-- Responsive -->
...
<!-- <div class="container"> -->
  ...
  <tr>
    ...
    <th scope="col">Aviation</th>
    <th scope="col">DmgRound</th>
    <th scope="col">RateOfFire</th>
    <th scope="col">Ranges</th>
    <th scope="col">Angle</th>
    <th scope="col">Weapon1</th>
    <th scope="col">Weapon2</th>
    <th scope="col">Weapon3</th>
  </tr>
  </thead>
  <tbody>
    <?php
         $sql = "SELECT * FROM `fighters` ORDER BY `Image` ASC";
         ...
         if ($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
              ...
              echo '<td scope="col">'.$row['DmgRound'].'</td>';
              echo '<td scope="col">'.$row['RateOfFire'].'</td>';
              echo '<td scope="col">'.$row['Ranges'].'</td>';
              echo '<td scope="col">'.$row['Angle'].'</td>';
              echo '<td scope="col">'.$row['Weapon1'].'</td>';
              echo '<td scope="col">'.$row['Weapon2'].'</td>';
              echo '<td scope="col">'.$row['Weapon3'].'</td>';
              echo '</tr>';
